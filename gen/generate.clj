#!/usr/bin/env bb
;; Generate src/sprite/generated.rs from gen/frames.json.
;;
;;   just sprites                 # regenerate + verify
;;   bb gen/generate.clj --check  # fail if the tree is stale
;;
;; frames.json is the vendored copy of the ClaudePix 20x20 creature animations
;; (https://claudepix.vercel.app/). See ATTRIBUTION.md for how it was
...
(def ^:private root (-> *file* fs/parent fs/parent))          ; crate root
